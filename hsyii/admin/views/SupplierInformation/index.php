<div class="box">
      <div class="box-content">
    	<div class="box-header">
            <a class="btn" href="<?php echo $this->createUrl('create');?>"><i class="fa fa-plus"></i>添加供应商信息</a>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $model->getAttributeLabel('supplier_no');?></th>
                ...
                <tbody>
                    ...
                    <!--change by default id in any attribute-->
                        ...
                        <td><?php echo CHtml::link($v->supplier_no, array('update', 'id'=>$v->id)); ?></td>
