            ...
            <div style="display:block;" class="box-detail-tab-item">
                <table>
                    ...
                    <tr>
                        ...
                        <td width="30%">
                            <?php echo $form->textField($model, 'staff_no', array('class' => 'input-text', 'readonly' => true)); ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $form->textField($model, 'staff_log_name', array('class' => 'input-text', 'readonly' => true)); ?>
                ...
                <div class="mt15">
                    <table style='margin-top:5px;'>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $form->textField($model, 'created', array('class' => 'input-text', 'readonly' => true)); ?>
